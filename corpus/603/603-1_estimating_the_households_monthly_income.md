---
policy_id: "603-1"
title: "603-1 Estimating the Household's Monthly Income"
parent: "603 Determining Eligibility and Benefit Level"
source_url: "C:\Users\nabilahmed\Documents\Code\alaska policy eval\Policies\Food Stamp Program\603\603-1.md"
...
- How the estimated income amount was determined is documented in the Case Notes (CANO Case Notes).  See MS 603-1G for more on documentation requirements.
...
- UIBUnemployment Insurance Benefit stops because of excess earnings for two benefit weeks in a row, causing the UIBUnemployment Insurance Benefit recipient to miss one or more two-week payments.
...
For policy on determining self-employment income, see [MS 605-2D](../605/605-2_d.md).

603-1 F.      VERIFICATION OF INCOME

All countable income available to the household must be verified. Verification obtained must be documented in the Case Notes (CANOCase Notes). Income can be verified using check stubs, written or oral statements from the source of the income, or data interface information. For self-employment income verification, see [MS 605-2D(4)](../605/605-2_d.md#605_2_D_4__Verification_of_Self_Employment_Income_and_Expenses).
...
|  |  |  |
| --- | --- | --- |
| [Previous Section](603.md) |  | [Next Section](603-2.md) |
|  |  | [2008-01 (7/08)](../transmittals/previous_transmittals/2008-01_(7_08).md) |