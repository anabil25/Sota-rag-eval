---
policy_id: "100-9"
title: "100-9 Reporting Abuse and Neglect"
parent: "100 General Information"
source_url: "C:\Users\nabilahmed\Documents\Code\alaska policy eval\policies\100\100-9_reporting_abuse_and_neglect.md"
last_ingested: "2026-03-28"
cross_references:
  - "{'id': '100-10', 'keywords': 'conflict of interest, confidential information, employee ethics, unauthorized access, family cases'}"
  - "{'id': '100-8', 'keywords': 'HIPAA, protected health information, medical records, privacy notice, authorization'}"
---
...
Division of Public Assistance (DPADivision of Public Assistance) personnel may suspect abuse or neglect involving adults or children in families applying for or receiving Public Assistance benefits. Staff will report incidents of suspected abuse or neglect to agencies within the Department of Health. If a report is made, the staff member must carefully document on a Report of Contact (GEN 56AReport of Contact) form the event observed and how/when it was reported, including the names of any other witnesses.

100-9 A.      CHILD ABUSE AND NEGLECT

Division of Public Assistance (DPADivision of Public Assistance) staff will report observed or suspected child abuse or neglect as allowed by Alaska Statute (AS 47.17.020).
...
Adult Protective Services in the Division of Senior and Disability Services (DSDSDivision of Senior and Disabilities Services) of the Department of Health ([DOH](#)Department of Health) is the agency responsible for preventing or stopping harm to vulnerable adults.
...
1. The observations and suspicion must be recorded in detail on a Report of Contact (GEN 56AReport of Contact) form. The record must be as specific and factual as possible. For example: "3/15/08. While she was waiting in the office for an interview, I observed Mrs. X pinch her baby's arm twice, apparently to make it stop crying. The baby's upper arms and his cheeks appeared to be severely bruised and scratched."
2. Immediately after completing the Report of Contact (GEN 56AReport of Contact) form, the person making the report must telephone the nearest Office of Children's Services or the Adult Protective Services in Anchorage, give them an oral report of what was observed, and provide whatever additional information is requested.
3. When the call is complete, enter on the Report of Contact form the name of the person to whom the report was made and the date and time of the call, then sign, date, and place it in the case file.

|  |  |  |
| --- | --- | --- |
| [Previous Section](100-8_health_insurance_portability_and_accountability_act_(hipaa).md) |  | [Next Section](100-10_ethical_conduct.md) |
