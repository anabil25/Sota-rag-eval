---
policy_id: "440-4"
title: "440-4  Determining The Household's Monthly Income"
parent: "440 Income"
source_url: "C:\Users\nabilahmed\Documents\Code\alaska policy eval\Policies\Alaska Adult Public Assistance Manual\440\440-4_determining_the_household_s_monthly_income.md"
...
- How often will the household receive payments - i.e., monthly, twice a mont, bi-weekly, weekly, irregularly?
...
- How the estimated income amount was determined is documented in the Case Notes (CANO). See [MS 400-5](../400/400-5_documentation.md) for more on documentation requirements.
...
Bob is receiving unemployment insurance benefits (UIB ) of $210 a week, which is paid every two weeks in the amount of $420. He will receive UIBUnemployment Insurance Benefits payments on the 2nd, 16th, and 30th of November. However, he did not claim one week of benefits so one of these payments is for $210. He expects to claim every week of benefits in the future. Since November income is lower than normal, the caseworker must do a separate budget for this one month. The caseworker totals the three payments in November and divides the amount by three to get an average payment amount ($420 + $210 + $420 = $1050/3 = $350). Since the payments are bi-weekly (every other week), the caseworker multiplies this average payment amount by 2.15 to get an estimated monthly income amount for November ($350 x 2.15 = $752.50). Since the lower UIBUnemployment Insurance Benefits payment is not expected to continue, the caseworker anticipates $420 every two weeks for December and beyond and recalculates an estimated monthly income of $ 903 ($420 x 2.15 = $ 903 ).
...
Jenny is receiving unemployment benefits, but recently got a temporary part-time job. She received her regularly scheduled $200 UIBUnemployment Insurance Benefits check on May 7th for the two benefit weeks April 22 and April 29. She was not eligible for unemployment benefits for the next two weeks because of her earnings. She is no longer working and expects to get another $200 UIBUnemployment Insurance Benefits check around June 5. Since she only got one unemployment payment in May, the worker counts $200 unemployment income for May and her earnings paid in May. The caseworker must recalculate June benefits based on anticipated income for that month.
...
For policy on determining self-employment income, see MS [441-1D](../441/441-1_earned_income.md#441_1_E_NET_EARNINGS_FROM_SELF_EMPLOYMENT).

6.VERIFICATION OF INCOME

All countable income available to the household must be verified. Verification obtained must be documented in the Case Notes (CANO). Income can be verified using check stubs, written or oral statements from the source of the income, or data interface information. For self-employment income verification, see MSManual Section [441-1D](../441/441-1_earned_income.md#441_1_E_4__Verification).
...
|  |  |  |
| --- | --- | --- |
| [Previous Section](440-3_items_that_are_not_income.md) |  | [Next Section](../441/441_countable_income.md) |
|  |  | [MC #18 (7/08)](file:////hssjnuaobf2/dpa/Policy/Online_Manuals/APA_Manual/Working_Copy/Robohelp/Transmittals/Memo_MC__18.md) |