---
policy_id: "108-3"
title: "108-3 Guidelines for Creating the Free Form Section"
parent: "108 Notices"
source_url: "C:\Users\nabilahmed\Documents\Code\alaska policy eval\Policies\Administrative Procedures Manual\108\108-3_guidelines_for_creating_the_free_form_section.md"
...
Include dollar signs in notices for clarity when discussing income used in determination. For example, stating "the amount is $500" is more likely to be accurately understood as income compared to merely stating "the amount is 500."
...
Avoid the use of acronyms such as TATemporary Assistance for Alaska Temporary Assistance Program, and abbreviations such as "thru" for through."
...
Any information that was used as part of the eligibility decision must be included in the notice which include income, resources, and deductions. There are many [EIS](#)Eligibility Information System and [ARIES](#)Alaska's Resource for Integrated Eligibility Services notices that are pre-populated with some of the required elements, however, the caseworker will need to review each notice carefully to ensure all due process elements are present in the notice.
...
- Identify the person receiving the income. If there is more than one person with income in the household, list whose income it is.
...
- List and identify the type of standard deductions given such as telephone, heat, electricity, water, etc. (Example: We allowed a standard deduction for your monthly telephone, heating, and electricity expenses.)
- List and identify the type of non-standard deductions and the amount allowed such as rent, child care, child or spousal support paid, and any allowed medical expenses. (Example: A monthly deduction was allowed for your $800 rent and $150 child support payment.)

Note:

Each expense listed on the application must be included in the notice, regardless of whether the [SUD](#)Standard Utility Deduction is allowed.
...
- Be very clear and list precisely the information the client needs to provide and by what date in the notice.
...
- Encourage the client to reapply at any time. (Refer to the appropriate program policy manuals to determine if an application is required for failure to provide.)
...
108-3 D.      HELPFUL TIPS FOR EISEligibility Information System NOTICE SCREENS

Helpful hints for composing notices are available in EISEligibility Information System by pressing the F10 key on the NORE screen. The information includes tips on formatting, completing notice fields, and macros help.

|  |  |  |
| --- | --- | --- |
| [Previous Section](108-2_content_of_a_notice.md) |  | [Next Section](108-4_how_eis_notices_work.md) |
