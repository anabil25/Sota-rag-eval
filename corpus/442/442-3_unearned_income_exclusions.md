---
policy_id: "442-3"
title: "442-3 Unearned Income Exclusions"
parent: "442 Income Exclusions"
source_url: "C:\Users\nabilahmed\Documents\Code\alaska policy eval\Policies\Alaska Adult Public Assistance Manual\442\442-3_unearned_income_exclusions.md"
...
(Refer to section [442-3A(6)](#442_3_A_6__State_or_local_relocation_assistance_payments) below for policy on the treatment of relocation assistance provided by a state or political subdivision for a project that does not have any federal involvement.)
...
- Pell Grants
- State Student Incentive Grants (SIG)
...
5. Subtract costs for transportation (actual costs, such as bus pass or parking fees, or business mileage rate permitted by the Internal Revenue Service. Go to [http://www.irs.gov/taxpros/article/0,,id=156624,00.html](http://www.irs.gov/taxpros/article/0%2c%2cid%3d156624%2c00.html) for current standard mileage rates.)
6. Count the remaining amount as income in the month the assistance is received.
7. Any amount of money retained after the month of receipt is evaluated as a resource under manual section [432-4K(2)](../432/432-4_retained_cash_payments_and_in-kind_payments.md#432_4_K_2__Limited_Exclusion).
...
The 2017 Tax Cuts Jobs Act allowed Alaska Native Corporations to place assets in a settlement trust on effectively pre-tax basis. Payments from the settlement trusts are treated the same as other cash payments from an Alaska Native Corporation. See [MS 442-3(A)(8)(f)](#442_3_A_8__Alaska_Native_Claims_Settlement_Act__ANCSA__payments).
...
- Funded wholly by a state, political subdivision of a state, or an Indian tribe; and
...
Needs-based assistance is not the same as needs-based income. Refer to section [441-2D](../441/441-2_unearned_income.md#441_2_D_INCOME_BASED_ON_NEED) for the policy on needs-based income.
...
- Dividends and interest earned on countable resources are excluded from income.
- Dividends and interest earned on excluded resources may be counted or excluded from income depending on the character of the excluded resource. See the manual section related to a particular resource or income exclusion for further guidance on the treatment of dividends and interest earned on excluded resources
...
Any increase in the value of an excluded burial fund, or the excluded portion of a burial fund, because of interest accumulation or appreciation is excluded as income. (Refer to section [432-2D](../432/432-2_personal_property.md#432-2_D._BURIAL_FUND_EXCLUSION).)
...
|  |  |  |
| --- | --- | --- |
| [Previous Section](442-2_earned_income_exclusions.md) |  | [Next Section](442-4_the_order_in_which_income_exclusions_are_applied.md) |
|  |  | [MC #74 (12/25)](../transmittals/memo_mc__74(12_25).md) |