---
policy_id: "523"
title: "523 Medicaid Exceptions to APA Income Policy"
parent: "Adult Long-Term Care"
source_url: "C:\Users\nabilahmed\Documents\Code\alaska policy eval\Policies\Adult Long-Term Care\523_medicaid_exceptions_to_apa_income_policy\523_medicaid_except_to_income.md"
...
Countable income is determined according to the criteria of the APAAdult Public Assistance program, except as provided below:

523 A.      SOCIAL SECURITY BENEFITS

Increases in Social Security retirement, survivors, and disability insurance benefits and SSASocial Security Administration COLAs are disregarded for certain grandfathered individuals. See sections [531](../531_deemed_an_ssi_apa_recipient_under_the_pickle_amendment/531_deemed_under_the_pickle.md) and [540](../540_grandfathered_eligibility_categories/540_grandfathered_eligibility_categories.md).
...
To be considered reasonably compatible, income electronically reported by Department of Labor (DOL) must be within 10% of the client stated gross monthly income. The most recent quarter reported by [DOL](#)Department of Labor and Workforce Development is divided by three to get the average monthly income amount.

Note:

Apply the Income Exclusions listed in [APA MS 442](http://dpaweb.hss.state.ak.us/manuals/apa/442/442_income_exclusions.htm) before comparing the client's statement of earnings and [DOL](#)Department of Labor and Workforce Development electronic verification.

The verification code will need to be "interface" for client statement.

Actual income information must be used for the cost of care calculation described in section [570](../570_post_eligibility_treatment_of_income_(coca)/570_post_eligibility_and_coc.md) and Working Disabled Medicaid cases.
...
Client stated monthly gross earned income is $3,500
Subtract $20 = $3,480
Subtract $65 = $3,415
Subtract one half = $1,707.50
Client stated monthly gross earned income $1,707.50 
10% of $1,707.50 is $170.75

Add $170.75 to $1,707.50 = $1,878.25
Subtract $170.75 from $1,707.50 = $1,536.75

The 10% range determined by the client stated income is $1,536.75 - $1,878.25

The [DOL](#)Department of Labor and Workforce Development monthly average is $3,733.33
Subtract $20 = $3,713.33
Subtract $65 = $3,648.33
Subtract one half = $1,824.17

There is reasonable compatibility as the [DOL](#)Department of Labor and Workforce Development monthly average of $1,824.17 is within the 10% range.

523 C.      POST-ELIGIBILITY DETERMINATION

SSISupplemental Security Income benefits are disregarded in the post-eligibility determination process for the first two months of institutionalization of persons eligible under sections 1619(a) or (b) of the Social Security Act if the person was receiving SSISupplemental Security Income benefits in the month before entering the institution. See [section 530-E](../530/530_ssi_and_apa_related_categories.md#530_E___SECTION_1619_b___ELIGIBLES) for policy on 1619(b) eligible individuals.

523 D.      COST-OF-CARE DETERMINATION

The withheld portion of an SSASocial Security Administration overpayment is disregarded in the post-eligibility cost of care determination. Payments from Alaska’s Senior Benefits Program count as income in the cost of care determination. Because federal income tax returns are disregarded as income, they cannot be used to determine the cost of care for institutionalized individuals and certain individuals eligible for services under a HCBHome and Community-Based waiver. However, the PNAPersonal Needs Allowance may still be increased to cover mandatory withholding from earned and unearned income to cover federal, state, and local taxes. See [section 570-E(1)](../570/570_post_eligibility_and_coc.md#570_E_1_Personal_Needs_Allowance_PNA).
...
This section does not apply to a disabled child living at home who is eligible under [MS 533](../533/533_disabled_children_at_home_(tefra).md) (TEFRATax Equity and Fiscal Responsibility Act, P.L. 97-248), which looks only at the child’s income.

523 G.      FEDERAL POVERTY GUIDELINES FOR ALASKA

The Federal Poverty Guidelines for Alaska are used in place of the APAAdult Public Assistance standard when determining eligibility for Qualified Medicare Beneficiary (QMBQualified Medicare Beneficiaries), Special Low-Income Medicare Beneficiary (SLMBSpecified Low Income Medicare Beneficiaries) categories, and Qualified Disabled and Working Individuals (QDWIQualified Disabled and Working Individuals) eligibility categories. See [Addendum  1](../addenda/addendum_1.md).

523 H.      IN-KIND SUPPORT AND MAINTENANCE

The APAAdult Public Assistance policy regarding the value of any support and maintenance that an individual or couple receives in-kind at [APA Manual section 440-3](http://dpaweb.hss.state.ak.us/manuals/apa/440/440-3_items_that_are_not_income.htm) does not apply when determining eligibility for the Special Long Term Care category. See [section 526-D](../526/526_qualifying_income_trusts.md#526_D__PAYMENTS_MADE_FROM_A_QIT) [for policy on how in-kind income is counted for the Special Long Term Care category.](JavaScript:hhctrl.TextPopup('MC 4 (10/06)','Arial,8',10,10,00000000,0xc0ffff))

523 I.      INDIVIDUAL INDIAN MONEY ACCOUNTS

Funds deposited or held in an Individual Indian Money (IIMIndividual Indian Money) account are excluded as income. (See [section 524-K](../524/524_medicaid_except_to_resource.md#524_K._____INDIVIDUAL_INDIAN_MONEY_ACCOUNTS) for resource policy on IIMIndividual Indian Money accounts.)
...
523 k.      dEVELOPMENT OF INCOME REQUIREMENTS DO NOT APPLY TO MEDICAID

Medicaid applicants and recipients are not required to pursue sources of income as a condition of Medicaid eligibility.

|  |  |  |
| --- | --- | --- |
| [Previous Section](../522_medicaid_exceptions_to_apa_eligibility_policy/522_medicaid_exception_to_apa_citizenship_requirements.md) |  | [Next Section](../524_medicaid_exceptions_to_apa_resource_policy/524_medicaid_except_to_resource.md) |
|  |  | [MC #70 (12/25)](../transmittals/previous_transmittals/mc__70_(12_25).md) |