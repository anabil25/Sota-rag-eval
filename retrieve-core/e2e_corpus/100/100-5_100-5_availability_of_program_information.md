---
policy_id: "100-5"
title: "100-5 Availability of Program Information"
parent: "100 General Information"
source_url: "C:\Users\nabilahmed\Documents\Code\alaska policy eval\policies\100\100-5_availability_of_program_information.md"
...
To the extent possible, the Division may translate publications, forms, applications, and other documents in the primary language of [LEP](#)Limited English Proficiency clients whenever appropriate. A list of materials in different languages is located on <http://dpaweb.hss.state.ak.us/node/156>.

If DPA receives correspondence (email, letter, fax), forms, or documents written in a language other than English, it should be sent to [hss.dpadost@alaska.gov](mailto:hss.dpadost@alaska.gov) for translation.

If the form is not available online and has not been translated into the language needed for the client, interpretative services will be used through the Division's Telelanguage line. See [Admin MS 100-6](100-6_interpreter_services.md) for more information on Interpreter Services.

|  |  |  |
| --- | --- | --- |
| [Previous Section](100-4_civil_rights.md) |  | [Next Section](100-6_interpreter_services.md) |
