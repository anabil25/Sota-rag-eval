---
policy_id: "116-2"
title: "116-2 Application Processing"
parent: "116 NFAP and DPA Case Processing Procedures"
source_url: "C:\Users\nabilahmed\Documents\Code\alaska policy eval\policies\116\116-2_application_processing.md"
last_ingested: "2026-03-26"
cross_references:
  - "{'id': '116-1', 'keywords': 'native family assistance, EIS eligibility system'}"
...
- Forward a copy of the application and all pertinent documents to the appropriate NFAPNative Family Assistance Program office no later than the next business day.
- Ensure the application and all pertinent documents are date-stamped before forwarding a copy to the NFAPNative Family Assistance Program office.
- Keep the original application and all pertinent documents in order for a DPADivision of Public Assistance caseworker to determine SNAPSupplemental Nutrition Assistance Program and/or Medicaid eligibility.
...
|  |  |  |
| --- | --- | --- |
| [Previous Section](116-1_introduction.md) |  | [Next Section](116-3_verification.md) |
