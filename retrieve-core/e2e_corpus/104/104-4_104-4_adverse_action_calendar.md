---
policy_id: "104-4"
title: "104-4 Adverse Action Calendar"
parent: "104 Statewide Process Management"
source_url: "C:\Users\nabilahmed\Documents\Code\alaska policy eval\policies\104\104-4_adverse_action_calendar.md"
last_ingested: "2026-03-26"
cross_references:
  - "{'id': '104-3', 'keywords': 'case notes, workload management, caseload reports'}"
...
For ongoing cases, the effective date of an adverse action (case closure or benefit reduction) is always the first day of the month following timely notice of adverse action. A notice of adverse action must be mailed at least 10 days before the effective date of the action. The adverse action date noted in the calendar is the last day an eligibility worker must prepare a notice on EISEligibility Information System for adverse actions taking effect the first day of the following month.

Determining Adverse Action Dates:

The 10-day count begins the day after the date the adverse action notice is mailed. It is important to remember that the date the notice is authorized in EISEligibility Information System is not the same as the date the notice is mailed. Notices are mailed the next business day after they are prepared. Most of the time, this means that notices are mailed the next day. However, if a notice is prepared on a Friday or on a day before a holiday, the notice will be mailed the following business day.
...
Benefit run dates indicate when Systems Support issues benefits. This information is used to inform clients when they should expect to receive their benefits.

|  |  |  |
| --- | --- | --- |
| [Previous Section](104-3_tools_for_effective_workload_management.md) |  | [Next Section](104-5_alerts.md) |
