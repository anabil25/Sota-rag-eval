---
policy_id: "122-3"
title: "122-3 Excessive Card Replacements"
parent: "122 Electronic Benefit Transfer (EBT)"
source_url: "C:\Users\nabilahmed\Documents\Code\alaska policy eval\policies\122\122-3_excessive_card_replacements.md"
last_ingested: "2026-03-31"
cross_references:
  - "{'id': '122-2', 'keywords': 'replace card, lost card, damaged card'}"
  - "{'id': '122-4', 'keywords': 'PIN setup, reset PIN, customer service'}"
---
...
The following [CANO](#)Case Notes is entered by [BIRU](#)Benefit Issuance & Recovery Unit staff when excessive card notice is returned:
...
A separate [CANO](#)Case Notes is entered when a field staff has discussed has discussed with the client about the excessive card replacements, documenting the reason for requesting excessive [EBT](#)Electronic Benefit Transfer card replacements. The following is an example of the [CANO](#)Case Notes entry made by a field staff after discussion with client:

[CANO](#)Case Notes Entry Example:
...
|  |  |  |
| --- | --- | --- |
| [Previous Section](122-2_issuing_a_quest_card_-_replacment_cards_for_ongoing_cases.md) |  | [Next Section](122-4_quest_card_personal_identification_number_(pin).md) |
|  |  | [2024-01 (04/24)](../transmittals/transmittal_2024-01.md) |