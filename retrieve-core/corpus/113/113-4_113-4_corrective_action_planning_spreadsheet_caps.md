---
policy_id: "113-4"
title: "113-4 Corrective Action Planning Spreadsheet (CAPS)"
parent: "113 Quality Assessment"
source_url: "C:\Users\nabilahmed\Documents\Code\alaska policy eval\policies\113\113-4_corrective_action_planning_spreadsheet_(caps).md"
last_ingested: "2026-03-31"
cross_references:
  - "{'id': '109-9', 'keywords': 'additional guidelines'}"
  - "{'id': '113-3', 'keywords': 'Q-form, corrective action, error documentation'}"
  - "{'id': '113-5', 'keywords': 'review documentation, case challenge, evidence access'}"
---
...
2. CAPSCorrective Action Planning Spreadsheets cases with errors will be corrected within two (2) days following the release of the error. Staff will follow Administrative Procedure Manual [Section 109-9H](../109/109-9_additional_guidelines.md#109-9_H._DOCUMENTING_CASE_CORRECTIONS_FOR_QA_ERRORS) for documentation criteria and case note title.
3. Completed GEN 95Report of Claim Determination forms must be emailed directly to [yvonne.algabre@alaska.gov](mailto:yvonne.algabre@alaska.gov). Please make sure that the subject line states "GEN 95 - CAPS."
...
|  |  |  |
| --- | --- | --- |
| [Previous Section](113-3_quality_assessment_feedback.md) |  | [Next Section](113-5_availability_of_complete_reviews.md) |
